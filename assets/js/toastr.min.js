!function(e) {
    e(["jquery"], function(e) {
        return function() {
            ...
            function c(t) {
                return v = e("<div/>").attr("id", t.containerId).addClass(t.positionClass).attr("aria-live", "polite").attr("role", "alert").css("width",($(document).width()-50)),
                v.appendTo((e(t.target).length>0?t.target:"body")),
