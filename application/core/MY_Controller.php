...
class MY_Controller extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->log_in_user_id = '1';//isset($this->log_in_user_id)?$this->log_in_user_id:helper_check_admin_login();
	...
	*/
	...
	{
		$user = array();//$this->user_model->get_user_info($this->session->user['id']);
		...
		$main_menu =$menu_items=$menu_for_view= '';
