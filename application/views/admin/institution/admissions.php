            ...
            <div class="col-12">
                ...
                <div class="text-zero top-right-button-container">
                  <a href="<?php echo base_url();?>institutions-enquiries">
                    <button type="button" class="btn btn-primary btn-lg top-right-button mr-1">Register New Student</button>
                  </a>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                           <div  id="ajax_data">
                                 <?php $this->load->view('admin/institution/admissions_ajax.php'); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="edit_admission" role="dialog" area-labelledby="edit_admission" data-backdrop="static">
  ...
  var base = $('#base_url').val();
    ...
    //SORTING
      ...
      $("body").on("click",'#reset-btn',function(){
       ...
       window.location.href='<?php echo base_url(); ?>institutions-admissions';
        return false;
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $.ajax({
      url:" <?php echo base_url().'export-institutions-admissions'; ?>",
      type: "POST",
      dataType : "json",
      data:{ 
 ...
 function edit_admission_by_id(id){
    $.ajax({
            url:'<?php echo base_url(); ?>edit-institutions-admissions',
            type:'post',
            dataType:'json',
            data:{id:id},
            beforeSend:function()
            ...
            success:function(response){
                if(response.type=='success')
                {
                    $('#edit_admission').html(response.view);
                    $('#edit_admission').modal('show');
                }
                else{
                    toastr[response.type](response.msg);
                }
