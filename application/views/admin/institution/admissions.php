                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                            ...
                            <table id="dataTableRows01" class="responsive nowrap data-table"
                                data-order="[[ 1, &quot;desc&quot; ]]">
                                <thead>
                                  <tr>
                                        <th>Sr. No.</th>
                                   ...
                                   <?php for($i=1;$i<11;$i++){ ?>   
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            substr('Certification in MS Office',0,10); ?></p>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="btn btn-xs btn-danger" onclick="return confirm('Do you really want to drop this course ?');">Drop Course</a>
...
<script type="text/javascript">
  var $dataTableRows01 = $("#dataTableRows01").DataTable({
        /*'serverSide': true,
        'ajax': {
            'url':'<?=base_url()?>institutions-getAjaxAdmissions'
          },*/
        bLengthChange: false,
        buttons: [
          'copy',
