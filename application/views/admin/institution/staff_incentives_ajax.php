    ...
    <table>
        ...
        <?php if($data!=""){
            ...
            <tr>
                ...
                <td>
                    <p class="text-muted"><?= get_value($row,'task_assign_date','-');?></p>
                </td>
                <td>
                ...
                <td>
                    ...
                    <a href="#" class="btn btn-xs btn-warning mb-1" onclick="delete_staff_incentives_by_id(<?= $row['id']?>);"><i class="simple-icon-trash"></i></a>
                </td>
            </tr>
           <?php $i++; }
            } else {
