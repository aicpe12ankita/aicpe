        ...
        <?php if($data!=""){ 
            ...
            foreach ($data as $row) { ?>  
                <tr>
                    ...
                    <td>
                        <p class="text-muted"><?= $row['first_name']." ".$row['middle_name']." ".$row['last_name']; ?></p>
                    </td>
                    <td>
                    ...
                    <td>
                        <p class="text-muted"><?= get_value($row,'whatsapp_no','-'); ?></p>
                    </td>
                    <td>
                        <p class="text-muted"><?= get_value($row,'assign_staff','-'); ?></p>
                    </td>
                    <td>
                        <a href="#" class="btn btn-xs btn-primary mb-1"><i class="simple-icon-note"></i></a>
                        <a href="javascript:void(0);" class="btn btn-xs btn-warning mb-1"  onclick="delete_aicpe_world_membership_by_id('<?php echo $row['id']; ?>');"><i class="simple-icon-trash"></i></a>
