                   ...
                   <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                            ...
                            <div  id="ajax_data">
                                 <?php $this->load->view('admin/institution/old_students_ajax.php'); ?>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  var base = $('#base_url').val();
    ...
    //SORTING
      ...
      $("body").on("click",'#reset-btn',function(){
       ...
       window.location.href='<?php echo base_url(); ?>institutions-old-students';
        return false;
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $.ajax({
      url:" <?php echo base_url().'export-institutions-old-students'; ?>",
      type: "POST",
      dataType : "json",
      data:{ 
  ...
  function delete_old_student_by_id(id){ 
    $.ajax({
              url: '<?php echo base_url(); ?>delete-institutions-old-students',
              type:'post',
              dataType: 'json',
              data: {id:id},
