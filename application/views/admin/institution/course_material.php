                ...
                <div class="col-12 col-lg-4 col-xl-4 col-left ">
                    <div class="card">
                      <div class="card-header progress-bar pt-20">
                            <h5 class="text-center">Upload Course Material</h5>
                        </div>
                        <div class="card-body">
                            <form id="exampleForm" class="tooltip-label-right" novalidate>
                                ...
                                <div class="form-group">
                                  <label class="text-small text-muted">Upload Data</label>
                                    ...
                                    <tbody>
                                       <?php for($i=1;$i<11;$i++){ ?>   
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-muted">MS Excel</p>
                                            </td>
                                            <td>
                                                <a href="#" class="btn btn-xs btn-outline-dark right">Download Data <i class="iconsminds-download"></i></a>
                                            </td>
                                            <td>
