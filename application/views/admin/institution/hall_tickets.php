                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                            <div  id="ajax_data">
                           <?php $this->load->view('admin/institution/hall_tickets_ajax'); ?>
                         </div>
                        </div>
                    </div>
                </div>
  ...
  var base = $('#base_url').val();
    ...
    //SORTING
      ...
      $("body").on("click",'#reset-btn',function(){
       ...
       window.location.href='<?php echo base_url(); ?>institutions-hall-tickets';
        return false;
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $.ajax({
      url:" <?php echo base_url().'export-institutions-hall-tickets'; ?>",
      type: "POST",
      dataType : "json",
      data:{ 
  ...
  function delete_hall_tickets_by_id(id){ 
    $.ajax({
              url: '<?php echo base_url(); ?>delete-institutions-hall-tickets',
              type:'post',
              dataType: 'json',
              data: {id:id},
