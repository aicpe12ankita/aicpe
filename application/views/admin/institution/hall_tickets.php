                            ...
                            <table id="dataTableRows01" class="data-table responsive nowrap data-table-standard"
                                ...
                                <tbody>  
                                    <tr>
                                        ...
                                        <td>
                                            <p class="text-muted">CER_R879JB</p>
                                        </td>
                                        <td>
                                            <p class="text-muted">GNI Institutions, Nagpur</p>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class="text-muted">07-02-2021</p>
                                        </td>
                                        <td>
                                            <p class="text-muted">CER_098HUYB</p>
                                        </td>
                                        <td>
                                            <p class="text-muted">NIT Institutions of Technology and Managemnt </p>
                                        </td>
                                        <td>
                                            <a href="#" class="btn btn-xs btn-warning mb-1"><i class="simple-icon-trash"></i></a>
                                        </td>
