    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div  id="ajax_data">
                 <?php $this->load->view('admin/institution/aicpe_courses_ajax.php'); ?>
                </div>
              </div>
            </div>
        </div>
  ...
  var base = $('#base_url').val();
    ...
    //SORTING
      ...
      $("body").on("click",'#reset-btn',function(){
       ...
       window.location.href='<?php echo base_url(); ?>institutions-aicpe-courses';
        return false;
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $.ajax({
      url:" <?php echo base_url().'export-institution-aicpe-courses'; ?>",
      type: "POST",
      dataType : "json",
      data:{ 
