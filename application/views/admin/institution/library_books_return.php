                            ...
                            <table id="dataTableRows01" class="data-table responsive nowrap data-table-standard"
                                ...
                                <thead>
                                   <tr>
                                        ...
                                        <th>Date of Return By Student</th>
                                        <th>Fine</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>  
                                    <tr>
                                        ...
                                        <td>
                                            <p class="text-muted">02-01-2021 - 02-03-2021</p>
                                        </td>
                                        <td>
                                            <p class="text-muted">15-03-2021</p>
                                        </td>
                                        <td>
                                            <p class="text-muted">Rs. 26</p>
                                        </td>
                                        <td>
...
<script type="text/javascript">
  var $dataTableRows01 = $("#dataTableRows01").DataTable({
        ...
        columns: [
          ...
          { data: "Mobile" },
          { data: "Email" },
          { data: "Date of Issue & Return" },
          { data: "Date of Return By student" },
          { data: "Fine" },
          { data: "Action" }
        ],
        language: {
