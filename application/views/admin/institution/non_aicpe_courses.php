    ...
    <main>
        <div class="row">
            <div class="col-12">
                ...
                <div class="text-zero top-right-button-container">
                  <button type="button" class="btn btn-primary btn-lg top-right-button mr-1" onclick="add_non_aicpe_course()">ADD NEW COURSE</button>
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div  id="ajax_data">
                 <?php $this->load->view('admin/institution/non_aicpe_courses_ajax.php'); ?>
                </div>
            </div>
        </div>
</main>
<div class="modal fade modal-right" id="addCourse" tabindex="-1" role="dialog" aria-labelledby="addCourse" aria-hidden="true">
...
function add_non_aicpe_course(no_id = '')
{
    $.ajax({
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $.ajax({
      url:" <?php echo base_url().'export-institution-non-aicpe-courses'; ?>",
      type: "POST",
      dataType : "json",
      data:{ 
    ...
    function delete_record(id)
    {
        bootbox.confirm({ 
            ...
            { 
                ...
                {
                    $.ajax({
                        url: "<?php echo base_url(); ?>delete-institution-non-aicpe-courses/",
                        type: "POST",
                        data: {no_id: id},
                        beforeSend: function()
                        {
