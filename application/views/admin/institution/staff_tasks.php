<?php $this->load->view('admin/includes/institution_header'); ?>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="add_staff_task_form" method="post"  role="form" onsubmit="return false;" name="add_staff_task_form">
                ...
                <div class="card-body">
                    ...
                    <div class="row" id="ajax_data">
                        <?php $this->load->view('admin/institution/staff_tasks_ajax.php');?>
                    </div>
                </div>
            </div>
                </div>
    ...
    <div class="modal fade modal-right" id="edit_staff_task" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
  </div>
...
<script type="text/javascript">
 $('#add_staff_task_form').on('submit',function(event){

    event.preventDefault();
//var brand_name = $('#brand_name').val().trim();
 var form_data = $('#add_staff_task_form').serialize();

$.ajax({
    url: '<?php echo base_url().'save-institutions-staff-tasks'; ?>',
    type: 'POST',
    dataType: 'json',
    data: form_data,
    beforeSend: function()
  ...
  var base = $('#base_url').val();
    ...
    //SORTING
      ...
      $("body").on("click",'#reset-btn',function(){
       ...
       window.location.href='<?php echo base_url(); ?>institutions-staff-tasks';
        return false;
...
<script type="text/javascript">
    ...
    $.ajax({
      url:" <?php echo base_url().'export-institutions-staff-tasks'; ?>",
      type: "POST",
      dataType : "json",
      data:{ 
...
function delete_staff_task_by_id(id){ 
    $.ajax({
              url: '<?php echo base_url(); ?>delete-institutions-staff-tasks',
              type:'post',
              dataType: 'json',
              data: {id:id},
...
function edit_staff_task_by_id(id){ 
    $.ajax({
              url: '<?php echo base_url(); ?>edit-institutions-staff-tasks',
              type:'post',
              dataType:'json',
              data: {id:id},
              ...
              success: function(data){
                ...
                {
                    $('#edit_staff_task').html(data.view);
                    $('#edit_staff_task').modal('show'); 
                    page_update();
                }
                else
                {
