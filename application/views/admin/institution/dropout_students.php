                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                             <div  id="ajax_data">
                                 <?php $this->load->view('admin/institution/dropout_students_ajax.php'); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="edit_dropout_students"  role="dialog" aria-labelledby="edit_dropout_student" data-backdrop="static">
 </div>
  ...
  var base = $('#base_url').val();
    ...
    //SORTING
      ...
      $("body").on("click",'#reset-btn',function(){
       ...
       window.location.href='<?php echo base_url(); ?>institutions-dropout-students';
        return false;
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $.ajax({
      url:" <?php echo base_url().'export-institutions-dropout-students'; ?>",
      type: "POST",
      dataType : "json",
      data:{ 
  ...
  function delete_dropout_students_by_id(id){ 
    $.ajax({
              url: '<?php echo base_url(); ?>delete-institutions-dropout-students',
              type:'post',
              dataType: 'json',
              data: {id:id},
   ...
   function edit_dropout_students_by_id(id){
        $.ajax({
          url:'<?php echo base_url();?>edit-institutions-dropout-students',
          type:'POST',
          dataType:'json',
          data:{id:id},
          ...
          success:function(data){
                ...
                {
                    $('#edit_dropout_students').html(data.view);
                    $('#edit_dropout_students').modal('show'); 
                }
                else
                {
