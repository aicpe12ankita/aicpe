      ...
      <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
             <form  id="edit_dropout_student_data" name="edit_dropout_student_data" method="post" enctype="multipart/form-data"  role="form" onsubmit="return false;">
              ...
              <div class="modal-body">
                ...
                <div class="separator mb-1"></div>
                    ...
                    <div class="col-sm-6" style="margin-bottom: 10px;">
                      ...
                      <input class="form-control" type="text" name="student_id" id="student_id" value="<?= $student_data['student_id'] ?>" readonly/>
                    </div>
                    ...
                    <div class="col-sm-6" style="margin-bottom: 10px;">
                      ...
                      <input class="form-control" type="text" name="email" id="email" value="<?= $student_data['email'] ?>" />
                    </div>
                    <div class="col-sm-6" style="margin-bottom: 10px;">
...
$('#edit_dropout_student_data').on('submit',function(event){

    event.preventDefault();
//var brand_name = $('#brand_name').val().trim();
 var form_data = $('#edit_dropout_student_data').serialize();

$.ajax({
    url: '<?php echo base_url().'save-institutions-dropout-students'; ?>',
    type: 'POST',
    dataType: 'json',
    data: form_data,
    beforeSend: function()
    ...
    {
        $('#edit_dropout_students').modal('hide');
