                            ...
                            <table id="dataTableRows01" class="data-table responsive nowrap data-table-standard" data-order="[[ 1, &quot;desc&quot; ]]">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <p class="badge badge-info">A</p>
                                        </td>
                                        <td>
                                            <p class="badge badge-success">Pass</p>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class="badge badge-info">D</p>
                                        </td>
                                        <td>
                                            <p class="badge badge-danger">Failed</p>
                                        </td>
                                        <td>
                                          <span class="badge badge-info">Requested For Certificate</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                         ...
                                         <td>
                                            <img src="<?php echo base_url();?>assets/img/profiles/l-6.jpg" class="img-thumbnail border-0 rounded-circle list-thumbnail table_img">
                                        </td>
                                        <td>
                                            <p class="text-muted">STUD_7587</p>
                                        </td>
                                        ...
                                        <td>
                                            <p class="text-muted">Certification in MS Office</p>
                                            <p class="text-muted"> 8 months</p>
                                        </td>
                                        <td>
                                            <p class="text-muted">Stud_012</p>
                                        </td>
                                        <td>
                                            <p class="text-muted">John@10</p>
                                        </td>
                                        ...
                                        <td>
                                            <p class="text-muted">72%</p>
                                        </td>
                                        <td>
                                            <p class="badge badge-info">A</p>
                                        </td>
                                        <td>
                                            <p class="badge badge-danger">Pass</p>
                                        </td>
                                        <td>
                                          <span class="badge badge-success">Certificate Delivered</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
