<?php $this->load->view('admin/includes/institution_header'); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                           <div id="ajax_data">
                            <?php $this->load->view('admin/institution/secret_codes_ajax.php');?>
                           </div>
                        </div>
                    </div>
                </div>
 ...
 <div class="modal fade" id="edit_secrete_code" role="dialog" aria-labelledby="edit_secrete_code"  data-backdrop="static">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $.ajax({
      url:" <?php echo base_url().'export-institutions-secrete-codes'; ?>",
      type: "POST",
      dataType : "json",
      data:{ 
