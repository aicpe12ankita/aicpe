<?php $this->load->view('admin/includes/institution_header'); ?>
                                ...
                                <tbody>
                                   <?php for($i=1;$i<11;$i++){ ?>   
                                    <tr>
                                        ...
                                        <td>
                                            <p class="text-muted">EXE-U43BF76</p>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <p class="text-muted">7815482600</p>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                           <p class="text-muted">21-02-2021</p>
                                        </td>
                                        <td>
                                            <p class="badge badge-success">Success</p>
                                        </td>
                                        <td>
                                          <a href="#" class="btn btn-xs btn-primary mb-1" data-toggle="modal" data-target="#editSecretCode"><i class="simple-icon-note"></i></a>
                                          ...
                                          <a href="#" class="btn btn-xs btn-outline-secondary mb-1">Send Mail</a>
                                          <a href="#" class="btn btn-xs btn-outline-warning mb-1">Send SMS</a>
                                          <a href="#" class="btn btn-xs btn-primary mb-1" data-toggle="modal" data-target="#feesStatus">Fees Status</a>
                                        </td>
                                    </tr>
                                   <?php } ?>
                                </tbody>
 ...
 <div class="modal fade" id="editSecretCode" tabindex="-1" role="dialog" aria-labelledby="editSecretCode" aria-hidden="true">
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              ...
              <div class="modal-body">
                <p class="text-muted">Student Name - John doe</p>
                <form>
                  <div class="form-group">
                    <label>Exam Secret Code</label>
                    <input type="text" name="exam_secret_code" class="form-control" value="EXE-U43BF76">
                  </div>
  ...
  <div class="modal fade" id="feesStatus" tabindex="-1" role="dialog" aria-labelledby="feesStatus" aria-hidden="true">
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              <div class="modal-header custom-modal">
                  <h5 class="modal-title white">Fees Status</h5>
                  <button type="button" class="close white" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                  </button>
              </div>
              <div class="modal-body">
               <p>Balance Fees : <span class="text-muted"> 1200</span></p>
               <button class="btn btn-xs btn-dark">Send Remainder</button>
              </div>
          </div>
      </div>
  </div>
