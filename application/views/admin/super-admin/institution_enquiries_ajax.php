                        <table class='custom_table table ' id='empTable' >
                                <thead>
                                   <tr>
                                        <th>Sr. No.</th>
                                        <th><a class="sorting" sort-by="iq_instname" sort-order="desc"  href="javascript:void(0)">Institution Name </a></th>
                                        <th>Course Code</th>
                                ...
                                <tbody class="list" data-check-all="checkAll">  
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class="text-muted"><?php echo ucfirst($row->iq_instname); ?></p>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <p class="text-muted"><?php echo $row->iq_email; ?></p>
                                        </td>
                                        <td>
                                            <p class="text-muted"><?php echo $row->iq_mobile; ?></p>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                         ...
                                         <td>
                                            <p class="text-muted"><?php echo date('d-m-Y h:ia',strtotime($row->iq_dateof_enquiry)); ?></p>
                                        </td>
                                        <td>
                                            
                                            <button type="button" class="btn btn-xs btn-warning mb-1" onclick="delete_institution_enquiry(<?php echo $row->iq_id; ?>)"><i class="simple-icon-trash"></i></button>
                                        </td>
                                    </tr>
                                   <?php $i++; } ?>  
                                </tbody>
