    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div  id="ajax_data">
                 <?php $this->load->view('admin/super-admin/field_staff_ajax'); ?>
                </div>
              </div>
            </div>
        </div>
...
<?php $this->load->view('admin/includes/footer'); ?>
 <div class="modal fade modal-right" id="addStaff" tabindex="-1" role="dialog" aria-labelledby="addStaff" aria-hidden="true">
     <?php $this->load->view('admin/super-admin/add_field_staff'); ?>
  ...
  var base = $('#base_url').val();
    ...
    //SORTING
      ...
      $("body").on("click",'#reset-btn',function(){
       ...
       window.location.href='<?php echo base_url(); ?>admin-field-staff';
        return false;
...
<script type="text/javascript">
  function get_staff_byId(type,id){
    ...
    $.ajax({
      url     : '<?php echo base_url(); ?>get-field-staff',
      type    : 'POST',
      dataType  : 'html',
 ...
 function delete_staff_byId(id){ 
    $.ajax({
              url: '<?php echo base_url(); ?>delete-field-staff',
              type:'post',
              data: {id:id},
              dataType: 'json',
              beforeSend: function()
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $.ajax({
      url:" <?php echo base_url().'admin-export-agent-and-other-staff'; ?>",
      type: "POST",
      dataType : "json",
      data:{ 
