    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4">
                  <div id="form_data">
                      <?php $this->load->view('admin/super-admin/master_tables/add_country'); ?>
                  </div>
                </div>
                <div class="col-lg-8">
                  <div class="card">
                    <div class="card-body">
                        ...
                        <div  id="ajax_data">
                         <?php $this->load->view('admin/super-admin/master_tables/countries_ajax'); ?>
                        </div>
                    </div>
            </div><!-- card -->
                </div><!-- col-lg-8 -->
    ...
    $('#add_country').validate({
      ...
      $.ajax({
              ...
              success: function(response){
                  if(response==true){
                    toastr.success('New country has been added successfully','Success',{timeOut:5000});
                    $( '#add_country' ).each(function(){
                        this.reset();
                    });
...
<script type="text/javascript">
  ...
  var base = $('#base_url').val();
    ...
    //SORTING
       ...
       window.location.href='<?php echo base_url(); ?>admin-countries';
        return false;
      });
  });
</script>
...
<script type="text/javascript">
    ...
    var base = $('#base_url').val();
        function get_country(type,id){
          $.ajax({
          url: base+'get-countries',
          type:'post',
          dataType:'html',
  ...
  function delete_country(id){
    var new_id = id;
       ...
       $.ajax({
                  ...
                  success: function(response){
                      if(response==true){
                        toastr.success('Country has been deleted successfully','Success',{timeOut:5000});
