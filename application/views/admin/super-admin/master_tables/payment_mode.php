    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4">
                  <div id="form_data">
                    <?php $this->load->view('admin/super-admin/master_tables/add_payment_mode'); ?>
                  </div>
                </div>
                <div class="col-lg-8">
                  <div class="card">
                    <div class="card-body">
                        ...
                        <div  id="ajax_data">
                         <?php $this->load->view('admin/super-admin/master_tables/payment_mode_ajax.php'); ?>
                        </div> 
                      </div>
                  </div>
                </div>
...
<script type="text/javascript">
    ...
    var base = $('#base_url').val();
        function get_payment_mode(type,id){
          $.ajax({
          url: base+'get-payment-mode',
          type:'post',
          dataType:'html',
    ...
    //SORTING
        $("body").on("click",'a.sorting[sort-by]',function(e)
        {
         ...
         $("body").on("click",'#reset-btn',function(){
          window.location.href='<?php echo base_url(); ?>admin-payment-mode';
          return false;
        });
      ...
      submitHandler: function(form) {
         // $('#add_payment_mode').on('submit', function(e){ 
          ...
          $.ajax({
                  ...
                  success: function(response){
                      if(response==true){
                        toastr.success('New payment mode has been added successfully','Success',{timeOut:5000});
  ...
  function delete_payment_mode(id){
    var new_id = id;
       ...
       $.ajax({
                  ...
                  success: function(response){
                      if(response==true){
                        toastr.success('Payment mode has been deleted successfully','Success',{timeOut:5000});
