        ...
        <div class="row">
          ...
          <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4">
                  <div id="form_data">
                    <?php $this->load->view('admin/super-admin/master_tables/add_distric'); ?>
                  </div>
                </div>
                <div class="col-lg-8">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div  id="ajax_data">
                         <?php $this->load->view('admin/super-admin/master_tables/districts_ajax.php'); ?>
                        </div>
                      </div>
                  </div>
              </div>
            ...
            var formdata = new FormData(form);
              $.ajax({
                      ...
                      success: function(response){
                          if(response==true){
                            toastr.success('New district has been added successfully','Success',{timeOut:5000});
                            $( '#add_district_form' ).each(function(){
                                this.reset();
                            });
...
<script type="text/javascript">
    ...
    var base = $('#base_url').val();
        function get_district(type,id){
          $.ajax({
          url: base+'get-districts',
          type:'post',
          dataType:'html',
  ...
  function delete_district(id){
    var new_id = id;
       ...
       $.ajax({
                  ...
                  success: function(response){
                      if(response==true){
                        toastr.success(' has been deleted successfully','Success',{timeOut:5000});
