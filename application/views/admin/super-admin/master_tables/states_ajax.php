<table class='custom_table table' id='empTable'>
            <thead>
               <tr>
                    <th>Sr. No.</th>
                    <th>Country</th>
                    <th><a class="sorting" sort-by="s_name" sort-order="desc"  href="javascript:void(0)">State </th>
                    <th>Action</th>
                </tr>
            </thead>
            <tbody> 
             <?php $i=$from_records; foreach ($data as $row) { ?>   
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-xs btn-primary mb-1 " onclick="get_state('edit',<?php echo $row->s_id; ?>)"><i class="simple-icon-note"></i></button>
                        <button type="button" class="btn btn-xs btn-warning mb-1" onclick="delete_state(<?php echo $row->s_id; ?>)"><i class="simple-icon-trash"></i></button>
                    </td>
                </tr>
               <?php $i++; } ?>
            </tbody>
