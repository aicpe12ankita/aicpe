<?php $this->load->view('admin/includes/admin_header'); ?>
    ...
    <main>
        <div class="row">
            <div class="col-12">
                <h1>Admin Staff Designations </h1>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4">
                    <div id="form_data">
                    <?php $this->load->view('admin/super-admin/master_tables/add_admin_staff_designation'); ?>
                  </div>
                </div>
                <div class="col-lg-8">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div  id="ajax_data">
                         <?php $this->load->view('admin/super-admin/master_tables/admin_staff_designation_ajax.php'); ?>
                        </div> 
                      </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    var base = $('#base_url').val();
        function get_admDesignation(type,id){
          $.ajax({
          url: base+'get-staff-designation',
          type:'post',
          dataType:'html',
...
<script type="text/javascript">
  ...
  var base = $('#base_url').val();
    ...
    //SORTING
       ...
       window.location.href='<?php echo base_url(); ?>admin-staff-designation';
        return false;
      });
  });
</script>
      ...
      messages:{
       ...
       // $('#add_admDesignation').on('submit', function(e){ 
         // e.preventDefault();
          ...
          $.ajax({
                  url: base+'add-staff-designation',
                  type:'post',
                  data: formdata,
                  processData: false,
                  contentType: false,
...
<script type="text/javascript">
  function delete_admDesignation(id){
    var new_id = id;

       $.ajax({
                  url: base+'delete-staff-designation',
                  type:'post',
                  data: {new_id:new_id},
                  dataType: 'json',
                  beforeSend: function()
