    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4">
                   <div id="form_data">
                      <?php $this->load->view('admin/super-admin/master_tables/add_world_content'); ?>
                  </div>
                </div>
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                          ...
                          <div  id="ajax_data">
                           <?php $this->load->view('admin/super-admin/master_tables/world_content_ajax.php'); ?>
                          </div>
                        </div>
                    </div>
                </div>
     ...
     $('#add_world_content').validate({
      ...
      $.ajax({
              ...
              success: function(response){
                  if(response==true){
                    toastr.success('New content has been added successfully','Success',{timeOut:5000});
...
<script type="text/javascript">
    ...
    var base = $('#base_url').val();
        function get_world_content(type,id){
          $.ajax({
          url: base+'get-aicpe-world-content',
          type:'post',
          dataType:'html',
    ...
    //SORTING
        $("body").on("click",'a.sorting[sort-by]',function(e)
        {
         ...
         $("body").on("click",'#reset-btn',function(){
          window.location.href='<?php echo base_url(); ?>admin-aicpe-world-content';
          return false;
        });
  });
</script>
...
<script type="text/javascript">
  function delete_world_content(id){
    var new_id = id;

       $.ajax({
                  url: base+'delete-aicpe-world-content',
                  type:'post',
                  data: {new_id:new_id},
                  dataType: 'json',
                  beforeSend: function()
                  ...
                  success: function(response){
                      if(response==true){
                        toastr.success('Content has been deleted successfully','Success',{timeOut:5000});
