    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4" >
                  <div id="form_data">
                    <?php $this->load->view('admin/super-admin/master_tables/add_city'); ?>
                  </div>
                </div>
                <div class="col-lg-8">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div  id="ajax_data">
                         <?php $this->load->view('admin/super-admin/master_tables/cities_ajax.php'); ?>
                        </div>
                      </div>
                    </div>
                </div>
    ...
    //SORTING
        $("body").on("click",'a.sorting[sort-by]',function(e)
        {
         ...
         $("body").on("click",'#reset-btn',function(){
          window.location.href='<?php echo base_url(); ?>admin-cities';
          return false;
        });
  });
</script>
    ...
    $("#add_city_form").validate({
        ...
        submitHandler: function(form) { 
            ...
            $.ajax({
                    ...
                    success: function(response){
                        if(response==true){
                          toastr.success('New city has been added successfully','Success',{timeOut:5000});
  ...
  function delete_city(id){
    var new_id = id;
       ...
       $.ajax({
                  ...
                  success: function(response){
                      if(response==true){
                        toastr.success('City has been deleted successfully','Success',{timeOut:5000});
