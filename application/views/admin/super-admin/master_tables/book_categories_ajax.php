        <table class='custom_table table' id='empTable'>
                <thead>
                   <tr>
                        <th>Sr. No.</th>
                        <th><a class="sorting" sort-by="category_name" sort-order="desc"  href="javascript:void(0)">Book Category</a></th>
                        <th>Action</th>
                    </tr>
                </thead>
                <tbody>  
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="text-muted"><?php echo ucfirst($row->category_name); ?></p>
                        </td>
                        
                        <td>
                            <button type="button" class="btn btn-xs btn-primary mb-1 " onclick="get_book_category('edit',<?php echo $row->id; ?>)"><i class="simple-icon-note"></i></button>
                            <button type="button" class="btn btn-xs btn-warning mb-1" onclick="delete_book_category(<?php echo $row->id; ?>)"><i class="simple-icon-trash"></i></button>
                        </td>
                    </tr>
                 <?php $i++; } ?>  
                </tbody>
