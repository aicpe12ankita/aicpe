    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4">
                  <div id="form_data">
                    <?php $this->load->view('admin/super-admin/master_tables/add_transaction_type'); ?>
                  </div>
                </div>
                <div class="col-lg-8">
                  <div class="card">
                    <div class="card-body">
                        ...
                        <div  id="ajax_data">
                         <?php $this->load->view('admin/super-admin/master_tables/transaction_type_ajax'); ?>
                        </div> 
                      </div>
                  </div>
                </div>
...
<script type="text/javascript">
    ...
    var base = $('#base_url').val();
        function get_transaction_type(type,id){
          $.ajax({
          url: base+'get-transaction-type',
          type:'post',
          dataType:'html',
  ...
  var base = $('#base_url').val();
    ...
    //SORTING
        ...
        $("body").on("click",'#reset-btn',function(){
          window.location.href='<?php echo base_url(); ?>admin-transaction-type';
          return false;
        });
      ...
      submitHandler: function(form) {
         // $('#add_transaction_type').on('submit', function(e){ 
          ...
          $.ajax({
                  ...
                  success: function(response){
                      if(response==true){
                        toastr.success('New transaction type has been added successfully','Success',{timeOut:5000});
...
<script type="text/javascript">
  function delete_transaction_type(id){
    var new_id = id;
       ...
       $.ajax({
                  url: base+'delete-transaction-type',
                  type:'post',
                  data: {new_id:new_id},
                  dataType: 'json',
                  beforeSend: function()
                  ...
                  success: function(response){
                      if(response==true){
                        toastr.success('Transaction type has been deleted successfully','Success',{timeOut:5000});
