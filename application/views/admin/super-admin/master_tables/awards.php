    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4">
                  <div id="form_data">
                    <?php $this->load->view('admin/super-admin/master_tables/add_award'); ?>
                  </div>
                </div>
                <div class="col-lg-8">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div  id="ajax_data">
                         <?php $this->load->view('admin/super-admin/master_tables/awards_ajax'); ?>
                        </div>
                      </div>
                    </div>
                </div>
      ...
      submitHandler: function(form){
        ...
        $.ajax({
              ...
              success: function(response){
                  if(response==true){
                    toastr.success('New award has been added successfully','Success',{timeOut:5000});
  ...
  var base = $('#base_url').val();
    ...
    //SORTING
        ...
        $("body").on("click",'#reset-btn',function(){
          window.location.href='<?php echo base_url(); ?>admin-awards';
          return false;
        });
  });
</script>
  ...
  function delete_award(id){
    var new_id = id;
       ...
       $.ajax({
                  ...
                  success: function(response){
                      if(response==true){
                        toastr.success('Award has been deleted successfully','Success',{timeOut:5000});
