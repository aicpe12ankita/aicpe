                        <table class='custom_table table' id='empTable'>
                                <thead>
                                   <tr>
                                        <th>Sr. No.</th>
                                        <th><a class="sorting" sort-by="isd_title" sort-order="desc"  href="javascript:void(0)">Payment Mode</a></th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>  
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class="text-muted"><?php echo ucfirst($row->p_title); ?></p>
                                        </td>
                                        
                                        <td>
                                            <button type="button" class="btn btn-xs btn-primary mb-1 " onclick="get_payment_mode('edit',<?php echo $row->p_id; ?>)"><i class="simple-icon-note"></i></button>
                                            <button type="button" class="btn btn-xs btn-warning mb-1" onclick="delete_payment_mode(<?php echo $row->p_id; ?>)"><i class="simple-icon-trash"></i></button>
                                        </td>
                                    </tr>
                                 <?php $i++; } ?>  
                                </tbody>
