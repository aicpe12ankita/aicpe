<table class='custom_table table' id='empTable'>
        <thead>
           <tr>
                ...
                <th>Country</th>
                <th>State </th>
                <th><a class="sorting" sort-by="d_district_name" sort-order="desc"  href="javascript:void(0)">District </th>
                <th>Action</th>
            </tr>
        </thead>
        <tbody> 
        <?php $i=$from_records; foreach ($data as $row) { ?> 
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-xs btn-primary mb-1 " onclick="get_district('edit',<?php echo $row->d_id; ?>)"><i class="simple-icon-note"></i></button>
                    <button type="button" class="btn btn-xs btn-warning mb-1" onclick="delete_district(<?php echo $row->d_id; ?>)"><i class="simple-icon-trash"></i></button>
                </td>
            </tr>
            <?php $i++; } ?>
        </tbody>
    </table> <!-- START PAGINATION -->
