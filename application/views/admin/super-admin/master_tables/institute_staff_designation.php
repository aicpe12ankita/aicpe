<?php $this->load->view('admin/includes/admin_header'); ?>
    ...
    <main>
        <div class="row">
            <div class="col-12">
                <h1>Institution Staff Designations </h1>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4">
                  <div id="form_data">
                    <?php $this->load->view('admin/super-admin/master_tables/add_institution_staff_designation'); ?>
                  </div>
                </div>
                <div class="col-lg-8">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div  id="ajax_data">
                         <?php $this->load->view('admin/super-admin/master_tables/institution_staff_designation_ajax.php'); ?>
                        </div> 
                      </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    var base = $('#base_url').val();
        function get_instDesignation(type,id){
          $.ajax({
          url: base+'get-institute-staff-designation',
          type:'post',
          dataType:'html',
  ...
  var base = $('#base_url').val();
    ...
    //SORTING
        ...
        $("body").on("click",'#reset-btn',function(){
          window.location.href='<?php echo base_url(); ?>admin-institute-staff-designation';
          return false;
        });
       ...
       // $('#add_admDesignation').on('submit', function(e){ 
         // e.preventDefault();
          ...
          $.ajax({
                  ...
                  success: function(response){
                      if(response==true){
                        toastr.success('New designation has been added successfully','Success',{timeOut:5000});
...
<script type="text/javascript">
  function delete_instDesignation(id){
    var new_id = id;

       $.ajax({
                  url: base+'delete-institute-staff-designation',
                  type:'post',
                  data: {new_id:new_id},
                  dataType: 'json',
                  beforeSend: function()
                  ...
                  success: function(response){
                      if(response==true){
                        toastr.success('Designation has been deleted successfully','Success',{timeOut:5000});
