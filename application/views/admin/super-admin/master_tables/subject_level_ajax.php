                        <table class='custom_table table' id='empTable'>
                                <thead>
                                   <tr>
                                        <th>Sr. No.</th>
                                        <th><a class="sorting" sort-by="sl_title" sort-order="desc"  href="javascript:void(0)">Subject Level</a></th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>  
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-xs btn-primary mb-1 " onclick="get_subject_level('edit',<?php echo $row->sl_id; ?>)"><i class="simple-icon-note"></i></button>
                                            <button type="button" class="btn btn-xs btn-warning mb-1" onclick="delete_subject_level(<?php echo $row->sl_id; ?>)"><i class="simple-icon-trash"></i></button>
                                        </td>
                                    </tr>
                                 <?php $i++; } ?>  
                                </tbody>
