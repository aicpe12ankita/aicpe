    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4">
                  <div id="form_data">
                    <?php $this->load->view('admin/super-admin/master_tables/add_qualification'); ?>
                  </div>
                </div>
                <div class="col-lg-8">
                  <div class="card">
                    <div class="card-body">
                        ...
                        <div  id="ajax_data">
                         <?php $this->load->view('admin/super-admin/master_tables/qualification_ajax.php'); ?>
                        </div> 
                      </div>
                  </div>
                </div>
...
<script type="text/javascript">
    ...
    var base = $('#base_url').val();
        function get_qualification(type,id){
          $.ajax({
          url: base+'get-qualification',
          type:'post',
          dataType:'html',
  ...
  var base = $('#base_url').val();
    ...
    //SORTING
        ...
        $("body").on("click",'#reset-btn',function(){
          window.location.href='<?php echo base_url(); ?>admin-qualification';
          return false;
        });
  });
</script>
      ...
      submitHandler: function(form) {
         ...
         // e.preventDefault();
          ...
          $.ajax({
                  ...
                  success: function(response){
                      if(response==true){
                        toastr.success('New qualification has been added successfully','Success',{timeOut:5000});
  ...
  function delete_qualification(id){
    var new_id = id;
       ...
       $.ajax({
                  ...
                  success: function(response){
                      if(response==true){
                        toastr.success('Qualification has been deleted successfully','Success',{timeOut:5000});
