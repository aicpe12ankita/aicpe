        <table class='custom_table table' id='empTable'>
                <thead>
                   <tr>
                        <th>Sr. No.</th>
                        <th><a class="sorting" sort-by="ph_title" sort-order="desc"  href="javascript:void(0)">Photo ID Type</a></th>
                        <th>Action</th>
                    </tr>
                </thead>
                <tbody>  
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="text-muted"><?php echo ucfirst($row->ph_title); ?></p>
                        </td>
                        
                        <td>
                            <button type="button" class="btn btn-xs btn-primary mb-1 " onclick="get_photo_id_type('edit',<?php echo $row->ph_id; ?>)"><i class="simple-icon-note"></i></button>
                            <button type="button" class="btn btn-xs btn-warning mb-1" onclick="delete_photo_id_type(<?php echo $row->ph_id; ?>)"><i class="simple-icon-trash"></i></button>
                        </td>
                    </tr>
                 <?php $i++; } ?>  
                </tbody>
