<?php $this->load->view('admin/includes/admin_header'); ?>
    ...
    <main>
        <div class="row">
            <div class="col-12">
                <h1>Employer Staff Designations </h1>
                            ...
                            <table id="dataTableRows01" class="data-table responsive nowrap data-table-standard"
                                ...
                                <tbody>  
                                    <tr>
                                        ...
                                        <td>
                                            <p class="text-muted">Administrative</p>
                                        </td>
                                        <td>
                                            <p class="text-muted description">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                        </td>
