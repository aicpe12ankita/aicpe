    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4">
                  <div id="form_data">
                    <?php $this->load->view('admin/super-admin/master_tables/add_photo_id_type'); ?>
                  </div>
                </div>
                <div class="col-lg-8">
                  <div class="card">
                    <div class="card-body">
                        ...
                        <div  id="ajax_data">
                         <?php $this->load->view('admin/super-admin/master_tables/photo_id_type_ajax.php'); ?>
                        </div> 
                      </div>
                  </div>
                </div>
        ...
        // $('form').on('submit', function(){ 
            ...
            $.ajax({
                    ...
                    success: function(response){
                        if(response==true){
                          toastr.success('New photo ID type has been added successfully','Success',{timeOut:5000});
...
<script type="text/javascript">
    ...
    var base = $('#base_url').val();
        function get_photo_id_type(type,id){
          $.ajax({
          url: base+'get-photo-id-type',
          type:'post',
          dataType:'html',
    ...
    //SORTING
        $("body").on("click",'a.sorting[sort-by]',function(e)
        {
         ...
         $("body").on("click",'#reset-btn',function(){
          window.location.href='<?php echo base_url(); ?>admin-photo-id-type';
          return false;
        });
  });
</script>
...
<script type="text/javascript">
  function delete_photo_id_type(id){
    var new_id = id;

       $.ajax({
                  url: base+'delete-photo-id-type',
                  type:'post',
                  data: {new_id:new_id},
                  dataType: 'json',
                  beforeSend: function()
                  ...
                  success: function(response){
                      if(response==true){
                        toastr.success('Photo ID Type has been deleted successfully','Success',{timeOut:5000});
