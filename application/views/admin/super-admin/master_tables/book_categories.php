    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4">
                  <div id="form_data">
                    <?php $this->load->view('admin/super-admin/master_tables/add_book_category'); ?>
                  </div>
                </div>
                <div class="col-lg-8">
                  <div class="card">
                    <div class="card-body">
                        ...
                        <div  id="ajax_data">
                         <?php $this->load->view('admin/super-admin/master_tables/book_categories_ajax.php'); ?>
                        </div> 
                      </div>
                  </div>
                </div>
     ...
     rules:{
      ...
      $.ajax({
              ...
              success: function(response){
                  if(response==true){
                    toastr.success('New book category has been added successfully','Success',{timeOut:5000});
...
<script type="text/javascript">
    ...
    var base = $('#base_url').val();
        function get_book_category(type,id){
          $.ajax({
          url: base+'get-book-categories',
          type:'post',
          dataType:'html',
    ...
    //SORTING
        $("body").on("click",'a.sorting[sort-by]',function(e)
        {
         ...
         $("body").on("click",'#reset-btn',function(){
          window.location.href='<?php echo base_url(); ?>admin-book-categories';
          return false;
        });
  });
</script>
...
<script type="text/javascript">
  function delete_book_category(id){
    var new_id = id;
       ...
       $.ajax({
                  url: base+'delete-book-categories',
                  type:'post',
                  data: {new_id:new_id},
                  dataType: 'json',
                  beforeSend: function()
                  ...
                  success: function(response){
                      if(response==true){
                        toastr.success('Book Category has been deleted successfully','Success',{timeOut:5000});
