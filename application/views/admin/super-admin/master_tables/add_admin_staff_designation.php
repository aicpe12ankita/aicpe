    ...
    <div class="card-body">
        <?= isset($type) && $type !=="" ? '<form id="edit_admDesignation" method="post">' : '<form id="add_admDesignation" method="post">' ?>
          <div class="form-group">
            <label>Title</label>
            <input type="text" class="form-control" name="title" value="<?= isset($desg) && $desg!="" ?  $desg->asd_title : "" ?>" required>
          </div>
          <div class="form-group">
            <label>Description</label>
            <textarea class="form-control" cols="2" name="description"> <?= isset($desg) && $desg!="" ?  $desg->asd_description : "" ?></textarea>
          </div>
          <input type="hidden" name="asd_id" value="<?= isset($desg) && $desg!="" ?  $desg->asd_id : "" ?>">
