                        <table class='custom_table table' id='empTable'>
                                <thead>
                                   <tr>
                                        <th>Sr. No.</th>
                                        <th><a class="sorting" sort-by="aw_title" sort-order="desc"  href="javascript:void(0)">Title</a></th>
                                        <th>Description </th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>  
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class="text-muted"><?php echo ucfirst($row->aw_title); ?></p>
                                        </td>
                                        <td>
                                            <p class="text-muted description"><?php echo ucfirst($row->aw_description); ?></p>
                                        </td>
                                        
                                        <td>
                                            <button type="button" class="btn btn-xs btn-primary mb-1 " onclick="get_award('edit',<?php echo $row->aw_id; ?>)"><i class="simple-icon-note"></i></button>
                                            <button type="button" class="btn btn-xs btn-warning mb-1" onclick="delete_award(<?php echo $row->aw_id; ?>)"><i class="simple-icon-trash"></i></button>
                                        </td>
                                    </tr>
                                   <?php $i++; } ?>  
                                </tbody>
