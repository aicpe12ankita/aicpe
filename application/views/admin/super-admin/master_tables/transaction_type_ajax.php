        <table class='custom_table table' id='empTable'>
                <thead>
                   <tr>
                        <th>Sr. No.</th>
                        <th><a class="sorting" sort-by="t_title" sort-order="desc"  href="javascript:void(0)">Transaction Type</a></th>
                        <th>Action</th>
                    </tr>
                </thead>
                <tbody>  
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="text-muted"><?php echo ucfirst($row->t_title); ?></p>
                        </td>
                        
                        <td>
                            <button type="button" class="btn btn-xs btn-primary mb-1 " onclick="get_transaction_type('edit',<?php echo $row->t_id; ?>)"><i class="simple-icon-note"></i></button>
                            <button type="button" class="btn btn-xs btn-warning mb-1" onclick="delete_transaction_type(<?php echo $row->t_id; ?>)"><i class="simple-icon-trash"></i></button>
                        </td>
                    </tr>
                 <?php $i++; } ?>  
                </tbody>
