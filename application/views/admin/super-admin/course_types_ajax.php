        <table class='custom_table table' id='empTable'>
                <thead>
                   <tr>
                        <th>Sr. No.</th>
                        <th><a class="sorting" sort-by="ct_title" sort-order="desc"  href="javascript:void(0)">Course Stream</a></th>
                        <th>Action</th>
                    </tr>
                </thead>
                <tbody>  
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="text-muted"><?php echo ucfirst($row->ct_title); ?></p>
                        </td>
                        
                        <td>
                            <button type="button" class="btn btn-xs btn-primary mb-1 " onclick="get_course_type('edit',<?php echo $row->ct_id; ?>)"><i class="simple-icon-note"></i></button>
                            <button type="button" class="btn btn-xs btn-warning mb-1" onclick="delete_course_type(<?php echo $row->ct_id; ?>)"><i class="simple-icon-trash"></i></button>
                        </td>
                    </tr>
                 <?php $i++; } ?>  
                </tbody>
