    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div  id="ajax_data">
                 <?php $this->load->view('admin/super-admin/course_suggestions_ajax.php'); ?>
                </div>
              </div>
            </div>
        </div>
  ...
  var base = $('#base_url').val();
    ...
    //SORTING
      ...
      $("body").on("click",'#reset-btn',function(){
       ...
       window.location.href='<?php echo base_url(); ?>admin-course-suggestions';
        return false;
...
<script type="text/javascript">
    ...
    $.ajax({
              url: '<?php echo base_url(); ?>delete-course-suggestions',
              type:'post',
              dataType: 'json',
              data: {id:id},
              ...
              success: function(response){
                  if(response==true){
                    toastr.success('Course suggestion has been deleted successfully','Success',{timeOut:5000});
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $.ajax({
      url:" <?php echo base_url().'export-course-suggestions'; ?>",
      type: "POST",
      dataType : "json",
      data:{ 
