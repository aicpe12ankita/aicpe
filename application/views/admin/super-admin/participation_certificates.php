                  ...
                  <tbody>
                    ...
                    <tr><td colspan="5">
                        <table class="table hide" id="data<?php echo $i; ?>">
                          ...
                          <tbody>
                            <tr>
                              <td><label class="custom-control custom-checkbox mb-1 align-self-center data-table-rows-check">
                                        <input type="checkbox" class="custom-control-input">
                                        <span class="custom-control-label">&nbsp;</span>
                                    </label></td>
                              <td>Sarah Kortney K</td>
                              <td>Test Seminar</td>
                              <td>XYZ Celebration Hall</td>
                              <td>02-02-2021</td>
                              <td><a href="#" class="btn btn-xs btn-info mb-1"><i class="simple-icon-eye"></i></a>
