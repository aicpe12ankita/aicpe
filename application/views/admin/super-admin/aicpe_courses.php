        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="text-zero top-right-button-container">
                  <button type="button" class="btn btn-primary btn-lg top-right-button mr-1" onclick="get_aicpe_course_byId('','');">Add Course</button>
      ...
      <div class="row">
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div  id="ajax_data">
                 <?php $this->load->view('admin/super-admin/aicpe_courses_ajax.php'); ?>
                </div>
              </div>
            </div>
        </div>
...
<div class="modal fade modal-right" id="addAssociateCourse" tabindex="-1" role="dialog" aria-labelledby="addAssociateCourse" aria-hidden="true">
     <?php $this->load->view('admin/super-admin/add_aicpe_course'); ?>
</div>
  ...
  var base = $('#base_url').val();
    ...
    //SORTING
      ...
      $("body").on("click",'#reset-btn',function(){
       ...
       window.location.href='<?php echo base_url(); ?>admin-aicpe-courses';
        return false;
...
<script type="text/javascript">
  function get_aicpe_course_byId(type,id){ 
       
    $.ajax({
      url     : '<?php echo base_url(); ?>get-aicpe-courses',
      type    : 'POST',
      dataType  : 'html',
 ...
 function delete_aicpe_course_byId(id){ 
    $.ajax({
              url: '<?php echo base_url(); ?>delete-aicpe-courses',
              type:'post',
              dataType: 'json',
              data: {id:id},
              ...
              success: function(response){
                  if(response==true){
                    toastr.success('AICPE course has been deleted successfully','Success',{timeOut:5000});
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $.ajax({
      url:" <?php echo base_url().'admin-export-admin-staff'; ?>",
      type: "POST",
      dataType : "json",
      data:{ 
