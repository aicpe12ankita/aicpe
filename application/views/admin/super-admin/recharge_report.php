                                ...
                                <tbody>
                                   <?php for($i=1; $i<11;$i++) { ?>   
                                    <tr>
                                        ...
                                        <td>
                                            <p class="text-muted">TU8760634</p>
                                        </td>
                                         <td>
                                            <p class="text-muted">T8970</p>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <p class="text-muted">23-09-1993</p>
                                        </td>
                                        <td>
                                            <p class="text-muted">Rs. 2300</p>
                                        </td>
                                        <td>
                                           <p class="text-muted">Nagpur, Nagpur</p>
                                        </td>
                                        <td>
                                           <p class="text-muted">Maharashtra</p>
                                        </td>
                                        <td>
                                           <p class="text-muted">Rs. 5300</p>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <p class="text-muted"><span class="badge badge-success">Success</span></p>
                                        </td>
                                        <td>
