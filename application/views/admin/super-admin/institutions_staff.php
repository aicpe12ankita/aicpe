        ...
        <div class="container-fluid">
            <div class="card">
                    <div class="card-body">
                        ...
                        <div  id="ajax_data">
                         <?php $this->load->view('admin/super-admin/institution_staff_ajax'); ?>
                        </div>
                    </div>
                  </div><!-- card -->
        </div>
   ...
   //SEARCH SUBMIT BUTTON EVENT
    ...
    //SORTING
      ...
      $("body").on("click",'#reset-btn',function(){
       ...
       window.location.href='<?php echo base_url(); ?>admin-institutions-staff';
        return false;
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $.ajax({
      url:" <?php echo base_url().'admin-export-institution-staff'; ?>",
      type: "POST",
      dataType : "json",
      data:{ 
