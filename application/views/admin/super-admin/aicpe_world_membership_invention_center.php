                                ...
                                <tbody>
                                   <?php for($i=1;$i<11;$i++){ ?>   
                                    <tr>
                                        ...
                                        <td>
                                            <p class="text-muted">9876783977</p>
                                        </td>
                                        <td>
                                            <p class="text-muted">john.doe@testmail.com</p>
                                        </td>
                                        <td>
                                            <p class="text-muted">A New Invention XYZ ABC</p>
                                        </td>
                                        <td>
                                           <p class="text-muted">XYZ ABC Institutions</p>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-xs btn-info" data-toggle="modal" data-target="#viewAssignment">view Article</a>
      ...
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              <div class="modal-header custom-modal">
                  <h5 class="modal-title white">Student's Invention </h5>
                  <button type="button" class="close white" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                  </button>
              </div>
              <div class="modal-body">
                  <h6>This is test invention title
                  <p class="right"> <span class="badge badge-warning">Pending</span></p></h6>
                  <p class="text-small"><strong>Utility For Society : </strong>  <span class="text-muted">LLorem Ipsum is simply dummy text of the printing and typesetting industry.</span></p>
                  <p class="text-small">
                  ...
                  <p><a href="#" class="">Download Attachment <i class="iconsminds-download"></i></a></p>
                  <form>
