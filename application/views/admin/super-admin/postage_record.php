<?php $this->load->view('admin/includes/admin_header'); ?>
    ...
    <main>
        <div class="row">
            <div class="col-12">
                <h1>Postage Records</h1>
                <div class="text-zero top-right-button-container">
                  <button type="button" class="btn btn-primary btn-lg top-right-button mr-1" data-toggle="modal" data-target="#addEnquiry">Add New Postage Record</button>
                </div>
                                ...
                                <tbody>
                                   <?php for($i=1;$i<11;$i++){ ?>   
                                    <tr>
                                        ...
                                        <td>
                                            <p class="text-muted">XYZ Institutions</p>
                                        </td>
                                        <td>
                                            <p class="text-muted">UFH_98JKDFT5</p>
                                        </td>
                                        <td>
                                            <p class="text-muted">03-01-2021</p>
                                        </td>
                                        <td>
                                        ...
                                        <td><span class="badge badge-success">Pending</span><a href="#">Change Status</a></td>
                                        <td>
      ...
      <div class="modal-dialog " role="document">
          <div class="modal-content">
              <div class="modal-header custom-modal">
                  <h5 class="modal-title white">Add New Postage Record</h5>
              ...
              <div class="modal-body">
                <form>
                  ...
                  <label class="form-group has-float-label">
                      ...
                      <span>Docket No.<span class="mandetory">*</span></span>
                  </label>
                  <label class="form-group has-float-label">
                      <input type="text" class="form-control" name="inst_name" />
                      <span>Postage Date <span class="mandetory">*</span></span>
                  </label>
                  
                  <label class="form-group has-float-label">
                      <input type="text" class="form-control" name="owner_name" />
                      <span>No. Of Certificates </span>
                  </label>
                  <label class="form-group has-float-label">
                      <input type="text" class="form-control" name="designation" />
                      <span>No. Of Marksheets</span>
                  </label>
                  <label class="form-group has-float-label">
                      <select class="form-control select2-single" data-width="100%" name="country">
                         <option value="TPZ">Yes</option>
                          <option value="TTZ">No</option>
                      </select>
                      <span>ATC Certificate <span class="mandetory">*</span></span>
                  </label>
                  <label class="form-group has-float-label">
                      <select class="form-control select2-single" data-width="100%" name="country">
                         <option value="TPZ">Yes</option>
                      ...
                      <span>Sample Kit <span class="mandetory">*</span></span>
                  </label>
                  <label class="form-group has-float-label">
                      <input type="text" class="form-control" name="inst_name" />
                      <span>Charges<span class="mandetory">*</span></span>
                  </label>
                  <label class="form-group has-float-label">
                      <select class="form-control select2-single" data-width="100%" name="country">
                         <option value="TPZ">Yes</option>
                      ...
                      <span>Send SMS <span class="mandetory">*</span></span>
                  </label>
...
<script type="text/javascript">
  var $dataTableRows01 = $("#dataTableRows01").DataTable({
        ...
        columns: [
          ...
          { data: "Docket No." },
          { data: "Postage Date" },
          { data: "No. of Certificate " },
          { data: "No. of Marksheet" },
          { data: "ATC Certificate" },
          { data: "Sample Kit" },
          { data: "Charges" },
          { data: "SMS" },
          { data: "Status" },
