    ...
    <main>
        <div class="row">
            <div class="col-12">
                ...
                <div class="text-zero top-right-button-container">
                  <button type="button" class="btn btn-primary btn-lg top-right-button mr-1" onclick="get_question_byId('','');">Add Question</button>
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div  id="ajax_data">
                 <?php $this->load->view('admin/super-admin/question_bank_ajax.php'); ?>
                </div>
              </div>
            </div>
        </div>
...
<div class="modal fade modal-right" id="addAssociateCourse" tabindex="-1" role="dialog" aria-labelledby="addAssociateCourse" aria-hidden="true">
     <?php $this->load->view('admin/super-admin/add_question_bank'); ?>
</div>
  ...
  var base = $('#base_url').val();
    ...
    //SORTING
      ...
      $("body").on("click",'#reset-btn',function(){
       ...
       window.location.href='<?php echo base_url(); ?>admin-question-bank';
        return false;
...
<script type="text/javascript">
  function get_question_byId(type,id){ 
    ...
    $.ajax({
      url     : '<?php echo base_url(); ?>get-question-bank',
      type    : 'POST',
      dataType  : 'html',
 ...
 function delete_question_byId(id){ 
    $.ajax({
              url: '<?php echo base_url(); ?>delete-question-bank',
              type:'post',
              dataType: 'json',
              data: {id:id},
