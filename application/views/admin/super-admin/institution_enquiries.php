          ...
          <div class="card">
                      <div class="card-body">
                        ...
                        <div class="row">
                          ...
                          <div id="ajax_data">
                           <?php $this->load->view('admin/super-admin/institution_enquiries_ajax'); ?>
                          </div>
                        </form>
                      </div>
                  </div>
...
<script type="text/javascript">
  function delete_institution_enquiry(id){
    var new_id = id;
    var base = $('#base_url').val();
       $.ajax({
                  url: base+'delete-institution-enquiry',
                  type:'post',
                  data: {new_id:new_id},
                  dataType: 'json',
                  beforeSend: function()
