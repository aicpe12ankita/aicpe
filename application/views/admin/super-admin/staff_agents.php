<?php $this->load->view('admin/includes/admin_header'); ?>
    ...
    <main>
        <div class="row">
            <div class="col-12">
                <h1>Agents and Other Staff List</h1>
                <div class="text-zero top-right-button-container">
                  <button type="button" class="btn btn-primary btn-lg top-right-button mr-1" onclick="get_staff_byId('','');">Add Staff </button>
                 </div>
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div  id="ajax_data">
                 <?php $this->load->view('admin/super-admin/agent_staff_ajax'); ?>
                </div>
              </div>
            </div>
        </div>
...
<?php $this->load->view('admin/includes/footer'); ?>
 <div class="modal fade modal-right" id="addStaff" tabindex="-1" role="dialog" aria-labelledby="addStaff" aria-hidden="true">
     <?php $this->load->view('admin/super-admin/add_agent_staff'); ?>
  ...
  var base = $('#base_url').val();
    ...
    //SORTING
      ...
      $("body").on("click",'#reset-btn',function(){
       ...
       window.location.href='<?php echo base_url(); ?>admin-agent-and-other-staff';
        return false;
...
<script type="text/javascript">
  function get_staff_byId(type,id){
       
    $.ajax({
      url     : '<?php echo base_url(); ?>get-agent-and-other-staff',
      type    : 'POST',
      dataType  : 'html',
 ...
 function delete_staff_byId(id){ 
    $.ajax({
              url: '<?php echo base_url(); ?>delete-agent-and-other-staff',
              type:'post',
              data: {id:id},
              dataType: 'json',
              beforeSend: function()
              ...
              success: function(response){
                  if(response==true){
                    toastr.success('Staff has been deleted successfully','Success',{timeOut:5000});
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $.ajax({
      url:" <?php echo base_url().'admin-export-field-staff'; ?>",
      type: "POST",
      dataType : "json",
      data:{ 
