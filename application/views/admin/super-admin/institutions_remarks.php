    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4">
                  <div id="form_data">
                    <?php $this->load->view('admin/super-admin/add_institution_remark'); ?>
                  </div>
                </div>
                <div class="col-lg-8">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div  id="ajax_data">
                         <?php $this->load->view('admin/super-admin/institutions_remarks_ajax'); ?>
                        </div>
                      </div>
                    </div>
                </div>
...
<?php $this->load->view('admin/includes/footer'); ?>
 <script type="text/javascript">
  $(document).ready(function(){ 
    $('#add_institution_remarks').validate({
      rules:{
        "inst":{
          required:true
        },
      ...
      submitHandler:function(form){
          ...
          $.ajax({
                  ...
                  success: function(response){
                      if(response==true){
                        toastr.success('New remark has been added successfully','Success',{timeOut:5000});
...
<script type="text/javascript">
    ...
    var base = $('#base_url').val();
        function get_inst_remarks(type,id){
          $.ajax({
          url: base+'get-institutions-remarks',
          type:'post',
          dataType:'html',
...
<script type="text/javascript">
  ...
  var base = $('#base_url').val();
    ...
    //SORTING
       ...
       window.location.href='<?php echo base_url(); ?>admin-institutions-remarks';
        return false;
...
<script type="text/javascript">
  function delete_inst_remarks(id){
    var new_id = id;

       $.ajax({
                  url: base+'delete-institutions-remarks',
                  type:'post',
                  data: {new_id:new_id},
                  dataType: 'json',
                  beforeSend: function()
                  ...
                  success: function(response){
                      if(response==true){
                        toastr.success('Institution remark has been deleted successfully','Success',{timeOut:5000});
