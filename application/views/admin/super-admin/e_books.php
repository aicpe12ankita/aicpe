    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4">
                   <div id="form_data">
                      <?php $this->load->view('admin/super-admin/add_e_book'); ?>
                  </div>
                </div>
                <div class="col-lg-8">
                  <div class="card">
                    <div class="card-body">
                        ...
                        <div  id="ajax_data">
                         <?php $this->load->view('admin/super-admin/e_books_ajax'); ?>
                        </div>
                    </div>
                  </div><!-- card -->
...
<script type="text/javascript">
    ...
    var base = $('#base_url').val();
        function get_e_book(type,id){
          $.ajax({
          url: base+'get-e-books',
          type:'post',
          dataType:'html',
  ...
  var base = $('#base_url').val();
    ...
    //SORTING
      ...
      $("body").on("click",'#reset-btn',function(){
       ...
       window.location.href='<?php echo base_url(); ?>admin-e-books';
        return false;
...
<script type="text/javascript">
  function delete_e_book(id){
    var id = id;

       $.ajax({
                  url: base+'delete-e-books',
                  type:'post',
                  data: {id:id},
                  dataType: 'json',
                  beforeSend: function()
                  ...
                  success: function(response){
                      if(response==true){
                        toastr.success('E-book has been deleted successfully','Success',{timeOut:5000});
   ...
   $(document).ready(function(){ 
    ...
    $('#add_e_book').validate({ 
      ...
      $.ajax({
              ...
              success: function(response){
                  if(response==true){
                    toastr.success('New E-book has been added successfully','Success',{timeOut:5000});
                    $( '#add_e_book' ).each(function(){
                        this.reset();
                    });
