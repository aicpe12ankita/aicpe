    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div  id="ajax_data">
                 <?php $this->load->view('admin/super-admin/admin_staff_ajax'); ?>
                </div>
              </div>
            </div>
        </div>
...
<?php $this->load->view('admin/includes/footer'); ?>
 <div class="modal fade modal-right" id="addStaff" tabindex="-1" role="dialog" aria-labelledby="addStaff" aria-hidden="true">
     <?php $this->load->view('admin/super-admin/add_admin_staff'); ?>
  ...
  var base = $('#base_url').val();
    ...
    //SORTING
      ...
      $("body").on("click",'#reset-btn',function(){
       ...
       window.location.href='<?php echo base_url(); ?>admin-administrative-staff';
        return false;
...
<script type="text/javascript">
  function get_staff_byId(type,id){
    ...
    $.ajax({
      url     : '<?php echo base_url(); ?>get-administrative-staff',
      type    : 'POST',
      dataType  : 'html',
 ...
 function delete_staff_byId(id){ 
    $.ajax({
              url: '<?php echo base_url(); ?>delete-administrative-staff',
              type:'post',
              data: {id:id},
              dataType: 'json',
              beforeSend: function()
