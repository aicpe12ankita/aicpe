    ...
    <nav class="navbar fixed-top">
        ...
        <div class="d-flex align-items-center navbar-center">
            <div class="div-navbar-logo">
               <span> <a class="navbar-logo" href="<?php echo base_url();?>employer-dashboard">
        ...
        <div class="navbar-right">
            ...
            <div class="user d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-right mt-3">
                    <a class="dropdown-item" href="<?php echo base_url(); ?>employer-profile">Profile</a>
                    <a class="dropdown-item" href="<?php echo base_url(); ?>employer-settings">Settings</a>
        ...
        <div class="main-menu">
            <div class="scroll">
                <ul class="list-unstyled">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>employer-post-jobs-report">
                            <i class="iconsminds-project"></i>
                            <span>Job Post</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>employer-applicants-list">
                            <i class="simple-icon-list"></i>
                            <span>Applicants List</span>
                        </a>
                    </li>
                    <!-- <li>
                        <a href="<?php echo base_url(); ?>employer-chatbox">
                            <i class="iconsminds-speach-bubble-comic-3"></i>
                            <span>Chat Box</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>employer-sms-management">
                            <i class="iconsminds-speach-bubble-dialog"></i>
                            <span>SMS Management</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>employer-contacts">
                            <i class="iconsminds-id-card"></i>
                            <span>Contacts</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>employer-wallet">
