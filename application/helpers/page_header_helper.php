<?php
    ...
    */
    ...
    function get_page_header_data($page_type)
    {
        ...
        $page_header_array['proposition_65_product_report'] = array(
            
            "breadcrumbs" =>  array(
                array('title'=>'Home','url'=>base_url()),
                array('title'=>'California Proposition 65 Product Report','is_active'=>TRUE),
            ),
            "page_title"  =>  'California Proposition 65 Product Report',
            "page_header_title" =>  'California Proposition 65 Product Report : '.$project_title
        ...
        $page_header_array['email_scheduler'] = array(
            
            "breadcrumbs" =>  array(
                array('title'=>'Home','url'=>base_url()),
                array('title'=>'Email Scheduler','is_active'=>TRUE),
            ),
            "page_title"  =>  'Email Scheduler',
            "page_header_title" =>  'Email Scheduler : '.$project_title
        ...
        $page_header_array['shopify_tier_profitability'] = array(
            
            "breadcrumbs" =>  array(
                array('title'=>'Home','url'=>base_url()),
                array('title'=>'Shopify Tier Profitability Setting','url'=>base_url().'shopify_tier_profitability_settings')
            ),
            "page_title"  =>  'Shopify Tier Profitability Setting',
            "page_header_title" =>  'Shopify Tier Profitability Setting '.$project_title
        ...
        $page_header_array['import_overstock_shipdate'] = array(

            'breadcrumbs' =>  array(
                array('title'=>'Home','url'=>base_url()),
                array('title'=>'Order','url'=>base_url().'order'),
                array('title'=>'Import Overstock Ship Date','is_active'=>TRUE)
            ),
            'page_title'  =>  'Import Overstock Ship Date',
            'page_header_title' =>  'Import Overstock Ship Date : '.$project_title
        );
        ...
        $page_header_array['payment_term'] = array(
            
            "breadcrumbs"    =>  array(
                array('title'=>'Home','url'=>base_url()),
                array('title'=>'Payment Terms','is_active'=> TRUE),
            ),
            "page_title"        =>  'Payment Terms',
            "page_header_title" =>  'Payment Terms : '.$project_title
        ...
        $page_header_array['picking_bin_trolley_location'] = array(
            "breadcrumbs" =>  array(
                array('title'=>'Home','url'=>base_url()),
                array('title'=>'Picking Bin Trolley Locations', 'is_active'=> TRUE)
            ),
            "page_title"  =>  'Picking Bin Trolley Locations',
            "page_header_title" =>  'Picking Bin Trolley Locations : '.$project_title
        );
        ...
        $page_header_array['shopify_bulk_listing_manager'] = array(
            "breadcrumbs" =>  array(
                array('title'=>'Home','url'=>base_url()),
                array('title'=>'Shopify Bulk Listing Manager', 'is_active'=> TRUE)
            ),
            "page_title"  =>  'Shopify Bulk Listing Manager',
            "page_header_title" =>  'Shopify Bulk Listing Manager : '.$project_title
        );
        ...
        $page_header_array['shopify_bulk_listing_product'] = array(
            "breadcrumbs" =>  array(
                array('title'=>'Home','url'=>base_url()),
                array('title'=>'Shopify Bulk Listing Manager', 'url'=>base_url().'shopify_bulk_listing_manager'),
                array('title'=>'Shopify Bulk Listing Products', 'is_active'=> TRUE)
            ),
            "page_title"  =>  'Shopify Bulk Listing Products',
            "page_header_title" =>  'Shopify Bulk Listing Products : '.$project_title
        );
        ...
        $page_header_array['fba_small_and_light_sku_report'] = array(
            "breadcrumbs" =>  array(
                array('title' =>'Home','url'=>base_url()),
                array('title' =>'FBA Small And Light SKU Report','is_active'=>TRUE),
            ),
            "page_title"        =>  'FBA Small And Light SKU Report',
            "page_header_title" =>  'FBA Small And Light SKU Report : '.$project_title
        );

         $page_header_array['order_avarage_delivery_date_report'] = array(
            "breadcrumbs" =>  array(
                array('title' =>'Home','url'=>base_url()),
                array('title' =>'Order Avarage Delivery Date Report','is_active'=>TRUE),
            ),
            "page_title"        =>  'Order Avarage Delivery Date Report',
            "page_header_title" =>  'Order Avarage Delivery Date Report : '.$project_title
        );
        
         $page_header_array['order_avarage_detail'] = array(
            "breadcrumbs" =>  array(
                array('title' =>'Home','url'=>base_url()),
                array('title' =>'Order List','is_active'=>TRUE),
            ),
            "page_title"        =>  'Order List',
            "page_header_title" =>  'Order List : '.$project_title
        );
        
        $page_header_array['ebay_catalouge_product_list'] = array(
            "breadcrumbs" =>  array(
                array('title' =>'Home','url'=>base_url()),
                array('title' =>'Ebay Catalog Product List','is_active'=>TRUE),
            ),
            "page_title"        =>  'Ebay Catalog Product List',
            "page_header_title" =>  'Ebay Catalog Product List : '.$project_title
        );

        $page_header_array['ss_activewear_product_list'] = array(
            "breadcrumbs" =>  array(
                array('title' =>'Home','url'=>base_url()),
                array('title' =>'S&S Activewear','is_active'=>TRUE),
            ),
            "page_title"        =>  'S&S Activewear',
            "page_header_title" =>  'S&S Activewear : '.$project_title
        );
        ...
        $page_header_array['amazon_product_policy_violations'] = array(
            "breadcrumbs" =>  array(
                array('title'=>'Home','url'=>base_url()),
                array('title'=>'Amazon Product Policy Violations : All', 'is_active'=> TRUE)
            ),
            "page_title"  =>  'Amazon Product Policy Violations : All',
            "page_header_title" =>  'Amazon Product Policy Violations : All : '.$project_title
        );
        
        $page_header_array['shipping_credentials_settings'] = array(
            
            "breadcrumbs" =>  array(
                array('title'=>'Home','url'=>base_url()),
                array('title'=>'Shipping Credentials','url'=>base_url().'global_settings/shipping_credentials')
            ),
            "page_title"  =>  'Shipping Credentials',
            "page_header_title" =>  'Shipping Credentials '.$project_title

        );

        $page_header_array['non_profitable_shipped_orders_by_month_report'] = array(
            
            "breadcrumbs" =>  array(
                array('title'=>'Home','url'=>base_url()),
                array('title'=>'Non-Profitable Shipped Orders By Month')
            ),
            "page_title"  =>  'Non-Profitable Shipped Orders By Month',
            "page_header_title" =>  'Non-Profitable Shipped Orders By Month '.$project_title
